    ...
    <form action="post">
      <div class="form-row">
        <div class="form-group col-md">
          ...
          <input class="col-md link-text" type="text" name="fname" placeholder="First Name" id="first-name" required>
        </div>
        <div class="col-md">
          <label class="col-md link-text" for="last-name">Last Name</label>
          <input class="col-md link-text" type="text" name="lname" placeholder="Last Name" id="last-name" required>
        </div>
      </div>
      <div class="form-row">
        <div class="col-md">
        ...
        <div class="col-md">
          ...
          <input class="col-md link-text" type="email" name="email" placeholder="Repeat Email Address" id="email" required>
        </div>
      </div>
      ...
      <div class="form-row-md link-text centered">
        ...
        <input class="submit formbutton centered" type="submit" value="Enter">
      </div>
    </form>
  </div>
